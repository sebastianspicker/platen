...
test('automation CLI commands require a root and use exact bounded argument shapes', () => {
  ...
  assert.deepEqual(parseCliArguments(['automation-watch-discover', 'inbox', '--automation-root', 'private']), { command: 'automation-watch-discover', input: 'inbox', automationRoot: 'private', output: null });
  assert.deepEqual(parseCliArguments(['automation-schedule-list', '--principal', 'alice', '--grant-id', 'grant_123', '--automation-root', 'private']), { command: 'automation-schedule-list', automationRoot: 'private', principal: 'alice', grantId: 'grant_123', output: null });
  assert.deepEqual(parseCliArguments(['automation-schedule-tick', '--principal', 'alice', '--grant-id', 'grant_123', '--now', '0', '--automation-root', 'private']), { command: 'automation-schedule-tick', automationRoot: 'private', principal: 'alice', grantId: 'grant_123', now: 0, output: null });
  assert.deepEqual(parseCliArguments(['automation-schedule-cancel', '--schedule-id', 'schedule_1', '--principal', 'alice', '--grant-id', 'grant_123', '--automation-root', 'private']), { command: 'automation-schedule-cancel', automationRoot: 'private', scheduleId: 'schedule_1', principal: 'alice', grantId: 'grant_123', output: null });
  assert.deepEqual(parseCliArguments(['automation-job-status', '--principal', 'alice', '--grant-id', 'grant_123', '--automation-root', 'private']), { command: 'automation-job-status', automationRoot: 'private', principal: 'alice', grantId: 'grant_123', output: null });
  assert.deepEqual(parseCliArguments(['automation-processing-report', 'job_1', 'job_2', '--principal', 'alice', '--grant-id', 'grant_123', '--automation-root', 'private']), { command: 'automation-processing-report', automationRoot: 'private', principal: 'alice', grantId: 'grant_123', jobIds: ['job_1', 'job_2'], output: null });
  assert.deepEqual(parseCliArguments(['automation-schedule-create', '--schedule-id', 'schedule_1', '--principal', 'alice', '--grant-id', 'grant_123', '--source-id', 'source_1', '--sha256', 'a'.repeat(64), '--operation-id', 'automation_inspect_v1', '--operation-kind', 'operation', '--first-at', '0', '--automation-root', 'private']), { command: 'automation-schedule-create', automationRoot: 'private', scheduleId: 'schedule_1', principal: 'alice', grantId: 'grant_123', sourceId: 'source_1', sha256: 'a'.repeat(64), operationId: 'automation_inspect_v1', operationKind: 'operation', pages: null, firstAt: 0, intervalMs: null, output: null });
  ...
  assert.throws(() => parseCliArguments(['automation-schedule-list', '--principal', 'alice', '--grant-id', 'short', '--automation-root', 'private']), { code: 'CLI_INVALID_OPTION' });
  assert.throws(() => parseCliArguments(['automation-processing-report', 'job_1', 'job_1', '--principal', 'alice', '--grant-id', 'grant_123', '--automation-root', 'private']), { code: 'CLI_INVALID_OPTION' });
  assert.throws(() => parseCliArguments(['automation-schedule-create', '--schedule-id', 'schedule_1', '--principal', 'alice', '--grant-id', 'grant_123', '--source-id', 'source_1', '--sha256', 'A'.repeat(64), '--operation-id', 'automation_inspect_v1', '--operation-kind', 'operation', '--first-at', '0', '--automation-root', 'private']), { code: 'CLI_INVALID_OPTION' });
});
