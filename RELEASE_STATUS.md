...
The fixture-only static demo and its Pages workflow are staged locally. They
have not been pushed or run, so no GitHub Pages deployment is verified. The
expected URL, `https://sebastianspicker.github.io/platen/`, must not be
presented as live until an authorized publication has completed and its Pages
deployment status has been checked.
