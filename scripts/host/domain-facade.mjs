...
const REGISTRY = Object.freeze({
  ...
  AEC: Object.freeze({
    ...
    createToolset: operation('Store a local markup toolset; source-bound requests do not create markups or change PDF bytes.', (d, id, b) => d.createToolset(id, b.input, b.options)),
    createReviewSession: operation('Store a source-bound local AEC review-session descriptor without network collaboration or PDF mutation.', (d, id, b) => d.createReviewSession(id, b.input, b.options)),
    measurementToolset: operation('Read the source-bound catalog of locally supported AEC measurement kinds.', (d, id, b) => d.measurementToolset(id, b.input, b.options)),
    ...
    evaluateCustomColumn: operation('Evaluate a safe arithmetic custom column.', (d, id, b) => d.evaluateCustomColumn(id, b.columnId, b.values, b.options)),
    ...
    createRevisionOverlay: operation('Store a local revision overlay descriptor without alignment, rendering, or PDF mutation.', (d, id, b) => d.createRevisionOverlay(id, b.input, b.options)),
    createBatchPlan: operation('Store a local batch-plan descriptor without replacing pages or changing PDF bytes.', (d, id, b) => d.createBatchPlan(id, b.input, b.options)),
    ...
    pageToGeo: operation('Convert a point using a local geospatial calibration.', (d, id, b) => d.pageToGeo(id, b.calibrationId, b.pagePoint, b.options)),
